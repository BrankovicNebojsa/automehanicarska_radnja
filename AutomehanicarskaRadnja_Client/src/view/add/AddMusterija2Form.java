...
public class AddMusterija2Form extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddMusterija2Form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddMusterija2Form(new FindVlasnikForm(new AddAutomobilForm())).setVisible(true);
            }
        });
    }
