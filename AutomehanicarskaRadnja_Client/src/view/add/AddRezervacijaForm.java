...
import tableModels.AddRezervacijaTableModel;
...
public class AddRezervacijaForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxRadnici.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jComboBoxRadnici.setPreferredSize(new java.awt.Dimension(370, 31));
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(jComboBoxRadnici, 0, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(jLabelAutomobilObaveza, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void jButtonDodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDodajActionPerformed
        if (isDataValid()) {
            ...
            rezervacija.setRadnik(findRadnik());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddRezervacijaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddRezervacijaForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> jComboBoxRadnici;
    ...
    private void prepareForm() {
        ...
        radnici = c.getRadnici();
        for (Radnik radnik1 : radnici) {
            jComboBoxRadnici.addItem(radnik1.getImeRadnika() + " " + radnik1.getPrezimeRadnika());
        }
    ...
    private boolean isDataValid() {
        ...
        if (jComboBoxRadnici.getSelectedItem() == null) {
    ...
    private Radnik findRadnik() {
        for (Radnik radnik1 : radnici) {
            ...
            if (combo.equals(jComboBoxRadnici.getSelectedItem())) {
                return radnik1;
            }
        }
        return null;
